...
import methodologyImage from '../images/CUBeeSEC Methodology.png';
  ...
  const tabs = [
    {
      ...
      content: "We collect intelligence on the application, map endpoints, hidden parameters, and technologies used. This sets the attack surface for further testing."
    },
    {
      title: "Authentication & Session Testing",
      content: "We test login mechanisms, password policies, MFA, session cookies, and tokens to detect weak authentication or hijacking flaws."
    },
    {
      title: "Input Validation & Injection Attacks",
      content: "We attempt SQL Injection, XSS, Command Injection, and template injection to ensure the app properly sanitizes user input."
    },
    {
      title: "Business Logic Testing",
      content: "We analyze workflows like payments, signups, and order processing to spot flaws attackers could exploit for financial or privilege gain."
    },
    {
      title: "Access Control Testing",
      content: "We validate user roles, test for Insecure Direct Object References (IDORs), horizontal/vertical privilege escalation, and broken authorization."
    },
    {
      title: "Sensitive Data Exposure",
      content: "We check for unencrypted storage, verbose error messages, hardcoded secrets, and insecure TLS configurations that could leak data."
    },
    {
      title: "Configuration & Deployment Review",
      content: "We review security headers, server misconfigurations, error handling, and outdated components that open doors to exploitation."
    },
    {
      title: "API & Third-Party Integrations",
      content: "We test APIs and integrations linked to the app for issues like broken authentication, improper rate-limiting, and data tampering."
    },
    {
      title: "Automation & Manual Exploitation",
      content: "Tools like Burp Suite, Nuclei, and custom scripts help detect common flaws, while manual testing validates real exploitability."
    }
  ];
  ...
  return (
    <section className="py-20 bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          CUBeeSEC's Approach for Web Application Penetration Testing 
        </motion.h2>
