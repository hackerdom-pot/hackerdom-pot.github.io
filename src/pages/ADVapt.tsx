...
import methodologyImage from '../images/ADPT Methodology.png';
...
const VulnerabilitySection = () => {
  ...
  const tabs = [
  {
    title: "Reconnaissance & Domain Mapping",
    content: "We begin by enumerating the AD environment to identify domain controllers, trusts, users, groups, and policies. Using both passive and active methods, we map the structure and gather intelligence that attackers would use to plan lateral movement."
  },
  {
    title: "User & Group Enumeration",
    content: "Cubeesec identifies all accessible accounts, privileged groups, and misconfigured permissions. By uncovering weak or unused accounts, excessive privileges, and exposed service accounts, we highlight potential entry points for privilege abuse."
  },
  {
    title: "Credential Harvesting & Password Attacks",
    content: "We safely test for password spraying, weak credential policies, and reuse across services. We also attempt to capture and analyze NTLM/Kerberos hashes, demonstrating how attackers could escalate through cracked or relayed credentials."
  },
  {
    title: "Privilege Escalation Techniques",
    content: "Once initial access is established, we test escalation paths. This includes exploiting misconfigured group policies, weak delegation, unconstrained Kerberos delegation, and token impersonation to elevate privileges toward domain admin."
  },
  {
    title: "Lateral Movement Simulation",
    content: "Our team simulates how attackers pivot across systems using compromised accounts. We leverage techniques like Pass-the-Hash, Pass-the-Ticket, and remote execution to show how an intruder could expand control within the network."
  },
  {
    title: "Active Directory Attack Path Analysis",
    content: "Using tools like BloodHound, we map and visualize potential attack paths from low-level users to high-value targets. This allows us to highlight weak trust relationships, poorly designed role hierarchies, and exploitable privilege chains."
  },{
    title: "Persistence & Domain Compromise Simulation",
    content: "We simulate persistence methods such as Golden Ticket, Silver Ticket, and DCSync attacks — without causing harm — to demonstrate how attackers could maintain long-term access once domain compromise is achieved."
  },{
    title: "Reporting & Remediation Guidance",
    content: "Finally, Cubeesec delivers a comprehensive report with detailed findings, proof-of-concepts, and prioritized remediation strategies. We provide actionable recommendations to strengthen account hygiene, harden group policies, enforce least privilege, and improve AD monitoring."
  },
];
  return (
    <section className="py-20 bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          CUBeeSEC's Approach for Active Directory Penetration Testing 
        </motion.h2>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            "True cybersecurity blends people, processes, and technology,  
            <span className="text-violet-400"> tools alone can’t stop a determined adversary.</span>"
            <motion.p 
