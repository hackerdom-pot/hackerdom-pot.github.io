...
import methodologyImage from '../images/MPT Methodology.png';
          ...
          <div className="relative h-full w-full p-12 flex items-center">
            ...
            >
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-lg">
                Cutting-edge security solutions to protect your Mobile Applications from Hackers and vulnerabilities.
              </p>
...
const VulnerabilitySection = () => {
  ...
  const tabs = [
  {
    title: "Reconnaissance & Application Mapping",
    content: "We begin by analyzing the mobile application to understand its structure and functionality. This includes identifying exposed features, integrated APIs, backend endpoints, and third-party SDKs. By mapping the attack surface early, we uncover potential entry points attackers may exploit."
  },
  {
    title: "Static Analysis",
    content: "Our team performs reverse engineering of the mobile app package (APK/IPA) to examine the underlying code. We search for hardcoded API keys, credentials, encryption flaws, insecure third-party libraries, and poor coding practices. This helps detect vulnerabilities before the app even runs."
  },
  {
    title: "Dynamic Analysis",
    content: "We execute the app in a controlled test environment and monitor its runtime behavior. By intercepting network traffic, API calls, and background processes, we detect insecure data flows, improper permission handling, and potential misuse of sensitive resources."
  },
  {
    title: "Authentication & Session Management Testing",
    content: "We rigorously test authentication mechanisms such as login flows, password policies, MFA, and biometric authentication. We also validate session tokens, cookies, and timeout policies to ensure attackers cannot hijack or replay sessions to gain unauthorized access."
  },
  {
    title: "Data Storage & Privacy Validation",
    content: "Cubeesec examines how the application stores and manages sensitive data. We look for exposed credentials, tokens, and personal information stored insecurely in local databases, device storage, caches, or logs. We also verify compliance with data protection best practices."
  },
  {
    title: "Communication Security Testing",
    content: "We analyze how the app communicates with its servers. This includes testing for weak SSL/TLS implementations, missing certificate pinning, and susceptibility to man-in-the-middle (MITM) attacks. Ensuring strong encryption safeguards users from data leakage and tampering."
  },{
    title: "Business Logic & Abuse Cases",
    content: "Beyond technical vulnerabilities, we assess the app’s workflows and processes for logic flaws. This includes testing payment systems, in-app purchases, and access control flows. Attackers often exploit overlooked logic flaws to bypass restrictions, gain financial advantages, or escalate privileges."
  },{
    title: "Reporting & Remediation Guidance",
    content: "At the end of the engagement, Cubeesec delivers a comprehensive report with clear findings, risk ratings, and proof-of-concepts. Each issue is accompanied by practical remediation strategies tailored for developers, ensuring vulnerabilities are not only identified but effectively resolved."
  },
];
  return (
    <section className="py-20 bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          CUBeeSEC's Approach for Mobile Application Penetration Testing 
        </motion.h2>
...
const VulnerabilitiesSection = () => {
  ...
  const vulnerabilities = [
    ...
    "Hardcoded Secrets",
    "Poor Reverse Engineering Protections",
    "Insecure WebViews"
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            "The weakest link in security is rarely the technology,  
            <span className="text-violet-400"> it’s the assumption that someone else is protecting it.</span>"
            <motion.p 
